...
public class RuntimeDecompiler extends IFernflowerLogger implements IResultSaver, IDecompiler {
   ...
   private final Map<String, Object> options = ImmutableMap.<String, Object>builder().put("din", "0").put("rbr", "0").put("dgs", "1").put("asc", "1").put("den", "1").put("hdc", "1").put("ind", "    ").build();
   ...
   public void saveClassFile(String path, String qualifiedName, String entryName, String content, int[] mapping) {
      ...
      try {
         ...
         org.spongepowered.include.com.google.common.io.Files.write(content, file, Charsets.UTF_8);
      } catch (IOException ex) {
