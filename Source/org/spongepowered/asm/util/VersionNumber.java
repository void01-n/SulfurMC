...
public final class VersionNumber implements Serializable, Comparable<VersionNumber> {
   ...
   public short getMajor() {
      return (short)((int)(this.value >> 48));
   }

   public short getMinor() {
      return (short)((int)(this.value >> 32 & 32767L));
   }

   public short getPatch() {
      return (short)((int)(this.value >> 16 & 32767L));
   }

   public short getRevision() {
      return (short)((int)(this.value & 32767L));
   }
   ...
   public int compareTo(VersionNumber other) {
      return other == null ? 1 : Long.compare(this.value, other.value);
   }
