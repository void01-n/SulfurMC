...
public class Message {
   ...
   public Message(IMessagerEx.MessageType type, CharSequence msg) {
      this((Diagnostic.Kind)type.getKind(), type.decorate(msg), (Element)null, (AnnotationMirror)((AnnotationMirror)null), (AnnotationValue)null);
   }

   public Message(Diagnostic.Kind kind, CharSequence msg) {
      this((Diagnostic.Kind)kind, msg, (Element)null, (AnnotationMirror)((AnnotationMirror)null), (AnnotationValue)null);
   }

   public Message(IMessagerEx.MessageType type, CharSequence msg, Element element) {
      this((Diagnostic.Kind)type.getKind(), type.decorate(msg), element, (AnnotationMirror)((AnnotationMirror)null), (AnnotationValue)null);
   }

   public Message(Diagnostic.Kind kind, CharSequence msg, Element element) {
      this((Diagnostic.Kind)kind, msg, element, (AnnotationMirror)((AnnotationMirror)null), (AnnotationValue)null);
   }

   public Message(IMessagerEx.MessageType type, CharSequence msg, Element element, AnnotationHandle annotation) {
      this((Diagnostic.Kind)type.getKind(), type.decorate(msg), element, (AnnotationMirror)annotation.asMirror(), (AnnotationValue)null);
   }

   public Message(Diagnostic.Kind kind, CharSequence msg, Element element, AnnotationHandle annotation) {
      this((Diagnostic.Kind)kind, msg, element, (AnnotationMirror)annotation.asMirror(), (AnnotationValue)null);
   }

   public Message(IMessagerEx.MessageType type, CharSequence msg, Element element, AnnotationMirror annotation) {
      this((Diagnostic.Kind)type.getKind(), type.decorate(msg), element, (AnnotationMirror)annotation, (AnnotationValue)null);
   }

   public Message(Diagnostic.Kind kind, CharSequence msg, Element element, AnnotationMirror annotation) {
      this((Diagnostic.Kind)kind, msg, element, (AnnotationMirror)annotation, (AnnotationValue)null);
   }
