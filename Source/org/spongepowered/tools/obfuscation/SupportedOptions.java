...
public final class SupportedOptions {
   ...
   public static Set<String> getAllOptions() {
      ImmutableSet.Builder<String> options = ImmutableSet.<String>builder();
      options.add("tokens", "outRefMapFile", "disableTargetValidator", "disableTargetExport", "disableOverwriteChecker", "overwriteErrorLevel", "defaultObfuscationEnv", "dependencyTargetsFile", "mappingTypes", "pluginVersion", "quiet", "showMessageTypes", "disableInterfaceMixins");
