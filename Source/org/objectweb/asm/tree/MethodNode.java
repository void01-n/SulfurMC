...
public class MethodNode extends MethodVisitor {
   ...
   public AnnotationVisitor visitInsnAnnotation(int typeRef, TypePath typePath, String descriptor, boolean visible) {
      ...
      TypeAnnotationNode typeAnnotation = new TypeAnnotationNode(typeRef, typePath, descriptor);
      if (visible) {
         currentInsn.visibleTypeAnnotations = Util.<TypeAnnotationNode>add(currentInsn.visibleTypeAnnotations, typeAnnotation);
      } else {
         currentInsn.invisibleTypeAnnotations = Util.<TypeAnnotationNode>add(currentInsn.invisibleTypeAnnotations, typeAnnotation);
      }
   ...
   public void visitTryCatchBlock(Label start, Label end, Label handler, String type) {
      ...
      this.tryCatchBlocks = Util.<TryCatchBlockNode>add(this.tryCatchBlocks, tryCatchBlock);
   }
   ...
   public AnnotationVisitor visitTryCatchAnnotation(int typeRef, TypePath typePath, String descriptor, boolean visible) {
      ...
      TypeAnnotationNode typeAnnotation = new TypeAnnotationNode(typeRef, typePath, descriptor);
      if (visible) {
         tryCatchBlock.visibleTypeAnnotations = Util.<TypeAnnotationNode>add(tryCatchBlock.visibleTypeAnnotations, typeAnnotation);
      } else {
         tryCatchBlock.invisibleTypeAnnotations = Util.<TypeAnnotationNode>add(tryCatchBlock.invisibleTypeAnnotations, typeAnnotation);
      }
   ...
   public void visitLocalVariable(String name, String descriptor, String signature, Label start, Label end, int index) {
      ...
      this.localVariables = Util.<LocalVariableNode>add(this.localVariables, localVariable);
   }
   ...
   public AnnotationVisitor visitLocalVariableAnnotation(int typeRef, TypePath typePath, Label[] start, Label[] end, int[] index, String descriptor, boolean visible) {
      ...
      if (visible) {
         this.visibleLocalVariableAnnotations = Util.<LocalVariableAnnotationNode>add(this.visibleLocalVariableAnnotations, localVariableAnnotation);
      } else {
         this.invisibleLocalVariableAnnotations = Util.<LocalVariableAnnotationNode>add(this.invisibleLocalVariableAnnotations, localVariableAnnotation);
      }
