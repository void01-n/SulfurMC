...
public class FrameNode extends AbstractInsnNode {
   ...
   public FrameNode(int type, int numLocal, Object[] local, int numStack, Object[] stack) {
      ...
      switch (type) {
         case -1:
         case 0:
            this.local = Util.<Object>asArrayList(numLocal, local);
            this.stack = Util.<Object>asArrayList(numStack, stack);
            break;
         case 1:
            this.local = Util.<Object>asArrayList(numLocal, local);
            break;
         case 2:
            this.local = Util.<Object>asArrayList(numLocal);
         case 3:
            break;
         case 4:
            this.stack = Util.<Object>asArrayList(1, stack);
            break;
         default:
