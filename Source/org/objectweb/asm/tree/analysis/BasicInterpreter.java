...
public class BasicInterpreter extends Interpreter<BasicValue> implements Opcodes {
         ...
         case 18:
            ...
            if (value instanceof Integer) {
               ...
               if (sort != 10 && sort != 9) {
                  ...
                  throw new AnalyzerException(insn, stringConcat$0(String.valueOf(value)));
               }
               ...
               throw new AnalyzerException(insn, stringConcat$1(String.valueOf(value)));
            }
         case 168:
   ...
   public BasicValue unaryOperation(AbstractInsnNode insn, BasicValue value) throws AnalyzerException {
      switch (insn.getOpcode()) {
         ...
         case 189:
            return this.newValue(Type.getType(stringConcat$2(String.valueOf(Type.getObjectType(((TypeInsnNode)insn).desc)))));
         case 190:
            return BasicValue.INT_VALUE;
         case 191:
            return null;
   ...
   public BasicValue merge(BasicValue value1, BasicValue value2) {
      return !value1.equals(value2) ? BasicValue.UNINITIALIZED_VALUE : value1;
   }
}
