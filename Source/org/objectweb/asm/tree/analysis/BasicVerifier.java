...
public class BasicVerifier extends BasicInterpreter {
   ...
   public BasicValue ternaryOperation(AbstractInsnNode insn, BasicValue value1, BasicValue value2, BasicValue value3) throws AnalyzerException {
      ...
      if (!this.isSubTypeOf(value1, expected1)) {
         throw new AnalyzerException(insn, "First argument", stringConcat$0(String.valueOf(expected1)), value1);
      ...
      if (opcode == 197) {
         for(BasicValue value : values) {
            if (!BasicValue.INT_VALUE.equals(value)) {
               throw new AnalyzerException(insn, (String)null, BasicValue.INT_VALUE, value);
            }
         }
      } else {
         int i = 0;
         ...
         while(i < values.size()) {
            ...
            BasicValue actual = (BasicValue)values.get(i++);
            if (!this.isSubTypeOf(actual, expected)) {
               throw new AnalyzerException(insn, stringConcat$1(j), expected, actual);
            }
         }
      }
