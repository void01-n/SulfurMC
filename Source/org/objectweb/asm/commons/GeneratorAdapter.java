   ...
   public void cast(Type from, Type to) {
      if (from != to) {
         if (from.getSort() < 1 || from.getSort() > 8 || to.getSort() < 1 || to.getSort() > 8) {
            throw new IllegalArgumentException(stringConcat$0(String.valueOf(from), String.valueOf(to)));
         }
   ...
   public void ifCmp(Type type, int mode, Label label) {
      switch (type.getSort()) {
         ...
         case 10:
            ...
            throw new IllegalArgumentException(stringConcat$1(String.valueOf(type)));
         default:
            int intOp = -1;
            switch (mode) {
               case 153:
